...
class Memorama {
    ...
    seleccionDificultad() {
      const mensaje = prompt(
        "Selecciona el nivel de dificultad en el que deseas jugar: Fácil , Intermedio, Difícil .Si no seleccionas un nivel por defecto el nivel seleccionado sera intermedio"
      );
      if (
        !mensaje ||
